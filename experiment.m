...
for repeats = 1:num_repeats 
        ...
        stopping_criterion_fulfilled = false;
          ...
          for iter = 1:maxiter
              ...
              if( iter > stopcrit_sample_pars.min_possible_iter_for_stopping ...
                  ...
                  iterstop_list(:,num_repeats,num_methods) = iter;
    ...
    for method_counter = 1:length(method_array)
        ...
        if real_setting
            ...
            figure
            plot(1:m,abs(b_exact),1:m,abs(b),':'); title('|b_{hat}|, |b|');
            title(['Last test instance of ' method_array{method_counter} ': abs. value of b in R(A) and noisy b'])
            figure
            ...
            title(['Last test instance of ' method_array{method_counter} ' method: abs. value of hidden sparse x_{hat} and last iterate x'])
