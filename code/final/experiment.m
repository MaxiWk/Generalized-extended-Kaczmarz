function data = experiment(n, m, sp, real_setting, lambda, T, L_gstar, maxiter, num_repeats, iter_save, ...
                          rowsamp, colsamp, writeout, dir_to_figures, fig_folder_name, savestep, ...
                          stopcrit_sample_pars, method_array, experiment_description)
